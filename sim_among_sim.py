...
for filename in matching_files:
    ...
    for nSample in list_nSamples:
        ...
        nSim = 1 #int(len(df)/nSample) #10000
        ...
        for replacement in [True, False]:
            ...
            if weighted:
                ...
                df_record = pd.DataFrame(ddf.compute().tolist(), columns=['sampled_ave', 'sampled_se', 'intervals_include_zero'])
                
                data['mean_intervals_include_zero'].append(df_record['intervals_include_zero'].mean())
                data['mean_sampled_ave_ln_ratio'].append(df_record['sampled_ave'].mean())
                data['se_sampled_ave_ln_ratio'].append(df_record['sampled_ave'].std()/sqrt(nSim))     
                data['mean_sampled_se_ln_ratio'].append(df_record['sampled_se'].mean())
                data['se_sampled_se_ln_ratio'].append(df_record['sampled_se'].std()/sqrt(nSim))
                print(data)
